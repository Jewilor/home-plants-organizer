...
Мобильный органайзер домашних растений на Flutter. Вариант 7, лабораторная 1.

- Список комнатных растений.
- Календарь полива, подкормки и пересадки.
- Красная карточка при просроченном поливе.

Данные демонстрационные, хранятся в памяти.
...
Из терминала: `flutter pub get`, затем `flutter run`.
